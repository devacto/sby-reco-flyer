...
- Every generation is also saved for rollback: copy the exported `reco_flyer.jpg` into `archive/` with a timestamped name and append a row to `archive/LOG.md`, committed and pushed alongside (exact recipe in the skill's Publish section).
